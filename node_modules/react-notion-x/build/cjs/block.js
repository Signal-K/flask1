...
var Block = function (props) {
    ...
    var blockId = "notion-block-" + notion_utils_1.uuidToId(block.id);
    switch (block.type) {
                        ...
                        react_1["default"].createElement("div", { className: 'notion-frame' },
                            ...
                            react_1["default"].createElement("div", { className: 'notion-page-scroller' },
                                ...
                                react_1["default"].createElement("main", { className: utils_1.cs('notion-page', hasPageCover
                                    ...
                                    pageHeader,
                                    react_1["default"].createElement("div", { className: 'notion-title' },
                                        react_1["default"].createElement(text_1.Text, { value: properties === null || properties === void 0 ? void 0 : properties.title, block: block })),
                                    block.type === 'page' &&
        ...
        case 'sub_sub_header': {
            ...
            return (react_1["default"].createElement("h3", { className: utils_1.cs(block.type === 'header' && 'notion-h notion-h1', block.type === 'sub_header' && 'notion-h notion-h2', block.type === 'sub_sub_header' && 'notion-h notion-h3', blockColor_2 && "notion-" + blockColor_2, indentLevelClass, blockId), "data-id": id },
        ...
        case 'code': {
            if (block.properties.title) {
                ...
                // TODO: add className
                return (react_1["default"].createElement(components.code, { key: block.id, language: language || '', code: content }));
            }
            break;
        }
        case 'column_list':
